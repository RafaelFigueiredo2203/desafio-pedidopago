  ...
  return(
    ...
    `} >
         ...
         @media (max-width: 1002px) {
          ...
          <svg className={css` @media (max-width: 1002px) {
                                width:42px;
                                height:41px;
                                margin-left:0px;
        } @media (max-width: 490px) {  margin-left:30px;}`} width="36" height="35" viewBox="0 0 36 35" fill="none" xmlns="http://www.w3.org/2000/svg">
